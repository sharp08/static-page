import{j as s,r as a,c as j}from"./index-B57d6L6K.js";import{F as y,d as _,b as C,x as m}from"./babel-DeP3F8yH.js";import"./isObject-BqFFb_eK.js";const R="/static-page/assets/icon-C5kMDUDs.svg",S="_header_1t8hc_9",A="_logo_1t8hc_18",v={header:S,logo:A};function N(){return s.jsx("div",{className:v.header,children:s.jsxs("div",{className:v.logo,children:[s.jsx("img",{alt:"logo",src:R}),s.jsx("span",{children:"React Playground"})]})})}const w=`{\r
  "imports": {\r
