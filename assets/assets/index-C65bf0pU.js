import{r as a,j as s,c as n}from"./index-B57d6L6K.js";import{B as x}from"./index-DR8HVwEw.js";import"./IconClose-Bvji1jpD.js";import"./IconTickCircle-v0hgm35U.js";import"./IconAlertTriangle-D8bz62LQ.js";const h="_container_1ny8d_1",j="_wrap_1ny8d_5",u="_polygon_1ny8d_14",y="_circle_1ny8d_21",_="_mouse_1ny8d_28",e={container:h,wrap:j,polygon:u,circle:y,mouse:_};function N(){const o=a.useRef(null),[l,d]=a.useState();function p(i){const r=o.current.getBoundingClientRect(),t=i.clientX-r.left,c=i.clientY-r.top,m=`
                M${t},${c-90}
                L${t+90},${c-30} 
                L${t+60},${c+70} 
                L${t-60},${c+70} 
