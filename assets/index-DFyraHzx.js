import{j as s,r as c,c as j}from"./index-CA-TbVeO.js";import{F as y,d as _,b as C,x as m}from"./babel-BulN-n99.js";const R="/assets/icon-C5kMDUDs.svg",S="_header_1t8hc_9",A="_logo_1t8hc_18",v={header:S,logo:A};function N(){return s.jsx("div",{className:v.header,children:s.jsxs("div",{className:v.logo,children:[s.jsx("img",{alt:"logo",src:R}),s.jsx("span",{children:"React Playground"})]})})}const w=`{\r
  "imports": {\r
...
`;function h(e){const t=e.split(".").pop()||"";return["js","jsx"].includes(t)?"javascript":["ts","tsx"].includes(t)?"typescript":["json"].includes(t)?"json":["css"].includes(t)?"css":"javascript"}const d="App.jsx",u="import-map.json",l="main.jsx",L={[l]:{name:l,language:h(l),value:F},[d]:{name:d,language:h(d),value:E},"App.css":{name:"App.css",language:"css",value:M},[u]:{name:u,language:h(u),value:w}},p=c.createContext({}),P=e=>{const{children:t}=e,[r,n]=c.useState(L),[o,i]=c.useState(d);return s.jsx(p.Provider,{value:{files:r,selectedFileName:o,setSelectedFileName:i,setFiles:n},children:t})};function U(){const{files:e,setFiles:t,selectedFileName:r}=c.useContext(p),n=e[r];function o(a){e[n.name].value=a,t({...e})}function i(a,g){a.addCommand(g.KeyMod.CtrlCmd|g.KeyCode.KeyJ,()=>{var x;(x=a.getAction("editor.action.formatDocument"))==null||x.run()})}return s.jsx(y,{height:"100%",path:n.name,language:n.language,onMount:i,onChange:_(o,500),value:n.value,options:{fontSize:14,scrollBeyondLastLine:!1,minimap:{enabled:!1},scrollbar:{verticalScrollbarSize:6,horizontalScrollbarSize:6}}})}const z="_tabs_11u95_1",I="_actived_11u95_30",f={tabs:z,"tab-item":"_tab-item_11u95_21",actived:I};function O(e){const{value:t,actived:r=!1,onClick:n}=e,o=j(f["tab-item"],r?f.actived:null);return s.jsx("div",{className:o,onClick:n,children:s.jsx("span",{children:t})})}function k(){const{files:e,selectedFileName:t,setSelectedFileName:r}=c.useContext(p),[n,o]=c.useState(Object.keys(e));return s.jsx("div",{className:f.tabs,children:n.map((i,a)=>s.jsx(O,{value:i,actived:t===i,onClick:()=>r(i)},i+a))})}function T(){return s.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%"},children:[s.jsx(k,{}),s.jsx(U,{})]})}function b(e,t,r){let n=W(e,t),o="";try{o=C.transform(n,{presets:["react","typescript"],filename:e,plugins:[H(r)],retainLines:!0}).code}catch(i){console.error("编译出错",i)}return o}function W(e,t){let r=t;const n=/import\s+React/g;return(e.endsWith(".jsx")||e.endsWith(".tsx"))&&!n.test(t)&&(r=`import React from 'react';
...
\r
</html>`;function Y(){const{files:e}=c.useContext(p),[t,r]=c.useState(n());function n(o){const i=K.replace('<script type="importmap"><\/script>',`<script type="importmap">${e[u].value}<\/script>`).replace('<script type="module" id="appSrc"><\/script>',`<script type="module" id="appSrc">${o}<\/script>`);return URL.createObjectURL(new Blob([i],{type:"text/html"}))}return c.useEffect(()=>{const o=J(e);r(n(o))},[e]),s.jsx("div",{style:{height:"100%"},children:s.jsx("iframe",{src:t,style:{width:"100%",height:"100%",padding:0,border:"none"}})})}function Q(){return s.jsx(P,{children:s.jsxs("div",{style:{height:"600px",background:"#e8e8e8"},children:[s.jsx(N,{}),s.jsxs(m,{defaultSizes:[100,100],children:[s.jsx(m.Pane,{minSize:300,children:s.jsx(T,{})}),s.jsx(m.Pane,{minSize:0,children:s.jsx(Y,{})})]})]})})}export{Q as default};
